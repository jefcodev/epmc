...
<ul class="breadcrumb">
  ...
  <div class="page-title"> <i class="icon-custom-right"></i>
    <h3>Nuevo <span class="semi-bold">Requisito</span></h3>
  </div>
  <div class="row">
    <div class="col-md-6">
      <div class="grid simple form-grid">
        ...
        <div class="grid-body no-border">
          <br>
            <form id="form_iconic_validation" action="{{ route('requisitos.store') }}" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <div class="form-group">
                <label class="form-label"><i class="required">*</i> Requisito</label>
