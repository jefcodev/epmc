...
@section('title','Edición artículo')
...
<ul class="breadcrumb">
  ...
  <div class="page-title"> <i class="icon-custom-right"></i>
    <h3>Edición <span class="semi-bold">Artículo</span></h3>
  </div>
  <div class="row">
    <div class="col-md-6">
      <div class="grid simple form-grid">
        ...
        <div class="grid-body no-border">
          <br>
            <form id="form_iconic_validation" action="{{ route('articulos.update',$articulo->id) }}" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <div class="form-group">
                ...
                <div class="input-with-icon  right">
                  <i class=""></i>
                  <input type="text" name="literal" id="literal" value="{{ $articulo->literal }}" class="form-control" required>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="input-with-icon  right">
                  <i class=""></i>
                  <input type="text" name="articulo" id="articulo" value="{{ $articulo->articulo }}" class="form-control" required>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <span class="help">eg: "1"</span>
                <div class="input-with-icon  right">
                  <i class=""></i>
                  <input type="number" name="orden" id="orden" value="{{ $articulo->orden }}"  class="form-control">
                </div>
              </div>
