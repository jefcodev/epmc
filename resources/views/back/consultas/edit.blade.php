            ...
            <form id="form_iconic_validation" action="{{ route('consultas.update',$consulta->id) }}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="input-with-icon  right">
                  <i class=""></i>
                  <input type="text" name="nombre" id="nombre" value="{{ $consulta->nombre }}" class="form-control" required>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="input-with-icon  right">
                  <i class=""></i>
                  <input type="text" name="url" id="url" value="{{ $consulta->url }}" class="form-control" required>
                </div>
              </div>
              <div class="form-group">
