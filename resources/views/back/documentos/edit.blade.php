...
@section('title','Edición documento')
...
<ul class="breadcrumb">
  ...
  <div class="page-title"> <i class="icon-custom-right"></i>
    <h3>Edición <span class="semi-bold">Documento</span></h3>
  </div>
  <div class="row">
    <div class="col-md-6">
      <div class="grid simple form-grid">
        ...
        <div class="grid-body no-border">
          <br>
            <form id="form_iconic_validation" action="{{ route('documentos.update',$documento->id) }}" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <div class="form-group">
                ...
                <div class="input-with-icon  right">
                  <i class=""></i>
                  <input type="text" name="nombre" id="nombre" value="{{ $documento->nombre }}" class="form-control" required>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="input-with-icon  right">
                  ...
                  <select name="categoria_id" class="form-control">
                    ...
                    <option value="{{$key}}" @if($documento->categoria_id==$key) selected @endif>{{$value}}</option>
                    @endforeach
                  </select>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="input-with-icon  right">
                  <i class=""></i>
                  <input type="text" name="descripcion" id="descripcion" value="{{ $documento->descripcion }}" class="form-control">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="input-with-icon  right">
                  <i class=""></i>
                  <input type="text" name="fecha" id="fecha" value="{{ $documento->fecha }}" class="form-control">
                </div>
              </div>
