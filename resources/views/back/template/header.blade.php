      ...
      <div class="pull-right">
        <div class="chat-toggler sm">
          <div class="profile-pic">
            <img src="{{ asset('front/img/users/'.Auth::user()->imagen) }}" alt="" data-src="{{ asset('front/img/users/'.Auth::user()->imagen) }}" data-src-retina="{{ asset('back/assets/img/profiles/avatar_small2x.jpg') }}" width="35" height="35" />
