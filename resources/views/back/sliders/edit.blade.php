        ...
        <div class="grid-body no-border">
          ...
          <form id="form_iconic_validation" action="{{ route('sliders.update', $slider->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="input-with-icon  right">
                <i class=""></i>
                <input type="checkbox" name="externo" id="externo" value="1" class="form-control"  @if($slider->externo) checked @endif>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="input-with-icon  right">
                <i class=""></i>
                <input type="number" name="orden" id="orden" value="{{ $slider->orden }}" class="form-control" required>
              </div>
            </div>
