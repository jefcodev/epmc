      ...
      <div class="grid simple ">
        <div class="grid-title">
          <h4>
            ...
            <a href="{{ route('roles.create') }}" class="btn btn-default" title="Nuevo usuario">
            ...
            <tbody>
              ...
              <tr class="odd gradeX" id="item{{ $usuario->id }}">
                <td>
                  {{ $usuario->name }}
                  <br>
                  <small>{{ $usuario->guard_name }}</small>
                </td>
                <td>
                  <a href="{{ route('roles.edit', $usuario->id) }}" title="Editar" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                  <a href="{{ route('roles.destroy', $usuario->id) }}" title="Eliminar" class="btn btn-danger btn-delete-item"><i class="fa fa-trash"></i></a>
                </td>
              </tr>
              @endforeach
            </tbody>
