          ...
          <br>
            <form id="form_iconic_validation" action="{{ route('categorias.update',$categoria->id) }}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="input-with-icon  right">
                  <i class=""></i>
                  <input type="text" name="url" id="url" value="{{ $categoria->url }}" class="form-control">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="input-with-icon  right">
                  <i class=""></i>
                  <input type="checkbox" name="externo" id="externo" @if($categoria->externo) checked @endif value="1" class="form-control">
                </div>
              </div>
