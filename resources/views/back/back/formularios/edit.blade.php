    ...
    <div class="col-md-6">
      <div class="grid simple form-grid">
        ...
        <div class="grid-body no-border">
          <br>
            <form id="form_iconic_validation" action="{{ route('formularios.update',$formulario->id) }}" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <div class="form-group">
                ...
                <div class="input-with-icon  right">
                  <i class=""></i>
                  <input type="text" name="nombre" id="nombre" value="{{ $formulario->nombre }}" class="form-control">
                </div>
              </div>
              <div class="form-group">
