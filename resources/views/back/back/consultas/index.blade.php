...
@section('content')
  ...
  <ul class="breadcrumb">
    ...
    <li><a href="{{ route('consultas.index') }}" class="active">Consultas</a> </li>
  </ul>
  <div class="page-title"> <i class="icon-custom-right"></i>
    <h3>Listado <span class="semi-bold">Consultas</span></h3>
  </div>
  <div class="row-fluid">
    <div class="span12">
      <div class="grid simple ">
        <div class="grid-title">
          <h4>
            Listado <span class="semi-bold">Consultas</span>
            <a href="{{ route('consultas.create') }}" class="btn btn-default" title="Nueva consulta">
        ...
        <div class="grid-body ">
          ...
          <table class="table table-striped" id="example2">
            ...
            <tbody>
              ...
              <tr class="odd gradeX" id="item{{ $consulta->id }}">
                <td>
                    {{ $consulta->nombre }}
                </td>
                <td class="center">{{ $consulta->descripcion }}</td>
                <td class="center"><a href="{{ $consulta->url }}" target="_blank">{{ $consulta->nombre }}</a></td>
                <td class="center">{{ $consulta->orden }}</td>
                <td>
                  <a href="{{ route('consultas.edit', $consulta->id) }}" title="Editar" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                  <a href="{{ route('consultas.destroy', $consulta->id) }}" title="Eliminar" class="btn btn-danger btn-delete-item"><i class="fa fa-trash"></i></a>
                </td>
              </tr>
              @endforeach
            </tbody>
