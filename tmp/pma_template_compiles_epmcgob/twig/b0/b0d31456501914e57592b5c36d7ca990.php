...
class __TwigTemplate_45704b9d5644e5e106f1cac58f65817c extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Close");
    ...
    {
        return new Source("", "error/report_modal.twig", "/usr/local/cpanel/base/3rdparty/phpMyAdmin/templates/error/report_modal.twig");
    }
}
